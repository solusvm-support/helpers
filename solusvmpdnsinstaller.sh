...
function configureMaster () {
	...
	curl -o pdns.sql https://support.solusvm.com/hc/en-us/article_attachments/360023860952/pdns.sql 
	...
	printf "\n\n\n"
	echo "-----------------------------------------------------"
	echo "Everything is done. Please take the information below and save it into $SLAVE_CONF file on slave server"
	...
	printf "\n Setup summary: \n PowerDNS Master Server IP: $(hostname -I) \n Database name: powerdns \n Username for mysql replication: pdnsslave \n Password for replication: %s\n" "$svmpassword"
}
